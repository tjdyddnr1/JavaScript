...
let resp = str.slice(7, 13); // 인덱스는 0부터 시작하고 종료 위치는 미만 개념
console.log(resp);

// substring() : slice()함수와 동일하며, 단 매개변수에 음수를 허용하지 않음.
let resp1 = str.substring(7); // 매개변수를 한 개만 넣으면 시작 인덱스부터 끝까지
console.log(resp1);
